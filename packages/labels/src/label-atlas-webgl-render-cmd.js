import { AtlasNode, Point, contentScaleFactor, FIX_ARTIFACTS_BY_STRECHING_TEXEL, LABELATLAS_DEBUG_DRAW, log } from "@aspect/core";
...
export class LabelAtlasWebGLRenderCmd extends AtlasNode.WebGLRenderCmd {
    ...
    rendering(ctx) {
        ...
        if (LABELATLAS_DEBUG_DRAW) {
            ...
            const vertices = [new Point(posX, posY), new Point(posX + s.width, posY),
                new Point(s.width + posX, s.height + posY), new Point(posX, posY + s.height)];
