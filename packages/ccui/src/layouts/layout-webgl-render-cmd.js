...
export class LayoutWebGLRenderCmd extends ProtectedNodeWebGLRenderCmd {
  ...
  stencilClippingVisit(parentCmd) {
    ...
    if (!this._beforeVisitCmdStencil) {
      this._beforeVisitCmdStencil = new CustomRenderCmd(
        this,
      ...
      this._afterVisitCmdStencil = new CustomRenderCmd(
        this,
  ...
  scissorClippingVisit(parentCmd) {
    if (!this._beforeVisitCmdScissor) {
      this._beforeVisitCmdScissor = new CustomRenderCmd(
        this,
        this._onBeforeVisitScissor
      );
      this._afterVisitCmdScissor = new CustomRenderCmd(
        this,
