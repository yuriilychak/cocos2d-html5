...
export class ControlHuePicker extends Control {
    ...
    set huePercentage(hueValueInPercent) {
        ...
        var backgroundBox = this._background.transformComponent.boundingBox;
    ...
    initWithTargetAndPos(target, pos) {
        if (super.init()) {
            ...
            this._slider.position = { x: pos.x, y: pos.y + this._background.transformComponent.boundingBox.height * 0.5 };
            this._startPos = pos;
            this._hue = 0.0;
