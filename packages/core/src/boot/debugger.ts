...
export const _LogInfos = {
    ...
    Node_reorderChild: "Node.order.reorderChild(): child must be non-null",
    Node_reorderChild_2: "Node.order.reorderChild(): this child is not in children list",
    Node_runAction: "Node.actionManager.runAction(): action must be non-null",
